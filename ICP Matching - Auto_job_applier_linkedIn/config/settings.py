...
# Force using a fresh guest (temporary) Chrome profile regardless of existing profiles.
# Set this True if you want the bot to always open a separate Chrome instance (recommended if your main profile is unstable or already logged-in and causes issues)
always_use_guest_profile = True      # True or False, Note: True or False are case-sensitive
